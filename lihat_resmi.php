  ...
  <div class="container">
    <div class="row content">
      ...
      <table class="table text-center">
        ...
        <tr>
          <td colspan="4" ><img src="logoamikom.png" width="300"></td>
        </tr>
        <tr>
          <td colspan="4" ><h3 style="margin:0; padding: 0;">MATA KULIAH : <?php echo $dosen['matkul']. "(" . $dosen['kode_matkul'] . ")";?></h3></td>
        </tr>
        <tr>
          <td colspan="4" ><h3 style="margin:0; padding: 0;">Program Studi: <?php echo $dosen['prodi'];?></h3></td>
        </tr>
        <tr>
          <td>NO</td>
          <td>Tgl Berlaku</td>
...
<table class="table text-center kop">
  <tr>
    <td rowspan="2">
      <img src="logoamikom.png" width="100">
    </td>
    <td rowspan="2">
      <h5>RENCANA PEMBELAJARAN SEMESTER (RPS)</h5>
      <h5>PROGRAM STUDI : <?php echo $dosen['prodi'];?></h5>
    </td>
    <td>
      <p><?php echo $dosen['kode_matkul'];?></p>
      <p>2 Agustus 2023</p>
      <p>Revisi 4</p>
    </td>
  ...
  <tr>
    ...
    <table class="table table-center kop">
        <tr>
          ...
          <td style="color: red;"> <?php echo $dosen['semester'];?></td>
        </tr>

        <tr>
          <td>Nama&kkode mata kuliah</td>
          <td style="color: red;"> <?php echo $dosen['matkul'] . "|" . $dosen['kode_matkul'];?></td>
          <td>bobot sks</td>
    ...
    <div class="card">
      <p> <?php echo $dosen['deskripsi'];?><br></p>
    </div>
    ...
    <div class="container-fluid">
      ...
      <table class="table kop">
        ...
        <tr style="color: red;">
          <td>PERTEMUAN 1</td>
          <td><?php echo $dosen['materi_per1'];?></td>
        </tr>
        <tr style="color: red;">
          <td>PERTEMUAN 2</td>
          <td><?php echo $dosen['materi_per2'];?></td>
        </tr>
        <tr style="color: red;">
          <td>PERTEMUAN 3</td>
          <td><?php echo $dosen['materi_per3'];?></td>
        </tr>
        <tr style="color: red;">
          <td>PERTEMUAN 4</td>
          <td><?php echo $dosen['materi_per4'];?></td>
        </tr>
        <tr style="color: red;">
          <td>PERTEMUAN 5</td>
          <td><?php echo $dosen['materi_per5'];?></td>
        </tr>
        <tr style="color: red;">
          <td>PERTEMUAN 6</td>
          <td><?php echo $dosen['materi_per6'];?></td>
        </tr>
        <tr style="color: red;">
          <td>PERTEMUAN 7</td>
          <td><?php echo $dosen['materi_per7'];?></td>
        </tr>
        <tr style="color: red;">
          <td>PERTEMUAN 8</td>
          <td><?php echo $dosen['materi_per8'];?></td>
        </tr>
        <tr style="color: red;">
          <td>PERTEMUAN 9</td>
          <td><?php echo $dosen['materi_per9'];?></td>
        </tr>
        <tr style="color: red;">
          <td>PERTEMUAN 10</td>
          <td><?php echo $dosen['materi_per10'];?></td>
        </tr>
        <tr style="color: red;">
          <td>PERTEMUAN 11</td>
          <td><?php echo $dosen['materi_per11'];?></td>
        </tr>
        <tr style="color: red;">
          <td>PERTEMUAN 12</td>
          <td><?php echo $dosen['materi_per12'];?></td>
        </tr>
        <tr style="color: red;">
          <td>PERTEMUAN 13</td>
          <td><?php echo $dosen['materi_per13'];?></td>
        </tr>
        <tr style="color: red;">
          <td>PERTEMUAN 14</td>
          <td><?php echo $dosen['materi_per14'];?></td>
        </tr>
      </table>
