...
$id = $_GET['kode_matkul'];
$sql = "SELECT * FROM table_matkul WHERE kode_matkul='$id'";
...
while ($dosen = mysqli_fetch_array($query)) {
    ...
    echo "<tr>" . "<td>" . "<p> PERTEMUAN 2 <a href='hapus2.php?materi2=" . $dosen['materi_per1'] . "'>Hapus</a>" . "<td>" . $dosen['materi_per2'] . "</tr>";
    echo "<tr>" . "<td>" . "<p> PERTEMUAN 3 <a href='hapus3.php?materi3=" . $dosen['materi_per1'] . "'>Hapus</a>" . "<td>" . $dosen['materi_per3'] . "</tr>";
    echo "<tr>" . "<td>" . "<p> PERTEMUAN 4 <a href='hapus.php?materi4=" . $dosen['materi_per1'] . "'>Hapus</a>" . "<td>" . $dosen['materi_per4'] . "</tr>";
    echo "<tr>" . "<td>" . "<p> PERTEMUAN 5 <a href='hapus.php?materi5=" . $dosen['materi_per1'] . "'>Hapus</a>" . "<td>" . $dosen['materi_per5'] . "</tr>";
    echo "<tr>" . "<td>" . "<p> PERTEMUAN 6 <a href='hapus.php?materi6=" . $dosen['materi_per1'] . "'>Hapus</a>" . "<td>" . $dosen['materi_per6'] . "</tr>";
    echo "<tr>" . "<td>" . "<p> PERTEMUAN 7 <a href='hapus.php?materi7=" . $dosen['materi_per1'] . "'>Hapus</a>" . "<td>" . $dosen['materi_per7'] . "</tr>";
    echo "<tr>" . "<td>" . "<p> PERTEMUAN 8 <a href='hapus.php?materi8=" . $dosen['materi_per1'] . "'>Hapus</a>" . "<td>" . $dosen['materi_per8'] . "</tr>";
    echo "<tr>" . "<td>" . "<p> PERTEMUAN 9 <a href='hapus.php?materi9=" . $dosen['materi_per1'] . "'>Hapus</a> " . "<td>" . $dosen['materi_per9'] . "</tr>";
    echo "<tr>" . "<td>" . "<p> PERTEMUAN 10 <a href='hapus.php?materi10=" . $dosen['materi_per1'] . "'>Hapus</a>" . "<td>" . $dosen['materi_per10'] . "</tr>";
    echo "<tr>" . "<td>" . "<p> PERTEMUAN 11 <a href='hapus.php?materi11=" . $dosen['materi_per1'] . "'>Hapus</a>" . "<td>" . $dosen['materi_per11'] . "</tr>";
    echo "<tr>" . "<td>" . "<p> PERTEMUAN 12 <a href='hapus.php?materi12=" . $dosen['materi_per1'] . "'>Hapus</a>" . "<td>" . $dosen['materi_per12'] . "</tr>";
    echo "<tr>" . "<td>" . "<p> PERTEMUAN 13 <a href='hapus.php?materi13=" . $dosen['materi_per1'] . "'>Hapus</a>" . "<td>" . $dosen['materi_per13'] . "</tr>";
    echo "<tr>" . "<td>" . "<p> PERTEMUAN 14 <a href='hapus.php?materi14=" . $dosen['materi_per1'] . "'>Hapus</a>" . "<td>" . $dosen['materi_per14'] . "</tr>";
